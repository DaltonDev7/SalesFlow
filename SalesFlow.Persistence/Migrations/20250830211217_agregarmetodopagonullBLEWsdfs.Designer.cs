...
namespace SalesFlow.Persistence.Migrations
{
    ...
    [Migration("20250830211217_agregarmetodopagonullBLEWsdfs")]
    partial class agregarmetodopagonullBLEWsdfs
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SalesFlow.Domain.Entities.HistoryOrders", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SalesFlow.Domain.Entities.Reservations", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("StatusReservation")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("SalesFlow.Domain.Entities.Tables", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SalesFlow.Domain.Entities.Order", b =>
                {
                    b.HasOne("SalesFlow.Domain.Entities.Customer", null)
                        .WithMany("Orders")
                        .HasForeignKey("CustomerId");

                    b.HasOne("SalesFlow.Domain.Entities.ApplicationUser", "Customer")
            ...
            modelBuilder.Entity("SalesFlow.Domain.Entities.Reservations", b =>
                {
                    ...
                    b.HasOne("SalesFlow.Domain.Entities.Tables", "Table")
                        .WithMany("Reservations")
